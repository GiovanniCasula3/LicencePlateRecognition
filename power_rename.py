...
rename_directory = "/Users/giovacasula/Projects/LicencePlateRecognition/license-plate-dataset/"
...
for letter in letters:
    folder_path = os.path.join(rename_directory, letter)
    ...
    if os.path.isdir(folder_path):
        ...
        for idx, filename in enumerate(files):
            ...
            new_filename = f"{letter}_{idx}{ext}"
